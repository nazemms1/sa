...
export const siteContent: Record<"ar" | "en", ContentTranslation> = {
  ar: {
    ...
    hero: {
      badge: "الشحن الدولي والخدمات اللوجستية المتكاملة",
      taglineHeader: "من مختلف المصادر والأسواق العالمية",
      titleStart: "شحن عالمي. خبرة إقليمية.",
      titleHighlight: "تسليم آمن وموثوق",
      titleEnd: "إلى سوريا.",
      subtitle:
      ...
      items: [
        {
          ...
          iconName: "ship",
          badge: "FCL / LCL",
          features: ["حلول الحاويات الكاملة المخصصة", "تجميع وتأطير الشحنات الجزئية", "تغطية تأمينية ملاحية شاملة"],
        },
        {
          id: "air-freight",
          title: "حلول الشحن الجوي السريع",
          description:
          ...
          iconName: "plane",
          badge: "شحن جوي سريع",
          features: ["شحن جوي للاستيراد والتصدير", "شحنات طارئة وحساسة للوقت", "تخليص المطار والتسليم النهائي"],
        },
        {
          id: "road-transit",
        ...
        },
        {
          ...
          title: "التخليص الجمركي والوثائق",
          description:
          ...
          iconName: "file-check",
          badge: "خبرة جمركية",
          features: ["معاملات الاستيراد والتصدير", "توثيق المستندات والبيانات", "تنسيق الإفراج عن البضائع"],
        },
        {
          id: "special-project",
    ...
    process: {
      sectionTag: "التنسيق اللوجستي الموحد",
    ...
    whyUs: {
      sectionTag: "لماذا S.A. LOGISTICS؟",
      title: "لماذا تختار شركة S.A. LOGISTICS؟",
      subtitle: "خبرة محلية عميقة • وصول إقليمي واسع • ارتباط لوجستي عالمي",
      guaranteeBadge: "بضاعتك.. التزامنا الكامل",
      motto: "دعنا ننقل شحنتك إلى سوريا بأمان وإتقان.",
      features: [
        {
          title: "الربط والوصول العالمي",
          description: "حلول شحن دولية متكاملة تنطلق من جميع المصادر والأسوق العالمية.",
          icon: "shield-check",
        },
        {
          title: "خبرة سوريا والشرق الأوسط",
          description: "دراية عميقة ودقيقة بالإجراءات والأنظمة الجمركية واللوجستية في سوريا والمنطقة.",
          icon: "building-2",
        },
        {
          title: "تنسيق متكامل من المبدأ للنهاية",
          description: "تنسيق كامل يبدأ من حجز الشحنة مروراً بالوثائق وحتى التخليص والتسليم النهائي.",
          icon: "award",
        },
        {
          title: "خدمات مخصصة للعملاء",
    ...
    quoteModal: {
      ...
      phonePlaceholder: "الهاتف / الواتساب (+963 9666 42574)",
      companyPlaceholder: "نوع البضاعة والحجم التقريبي",
      typeLabel: "اختر وسيلة الشحن",
      detailsPlaceholder: "ملاحظات إضافية (الوزن، CBM، ميناء الشحن بالصين، مدينة الوصول بسوريا)...",
      submitBtn: "إرسال طلب السعر فوراً",
      successMessage: "شكراً لك! تم استلام طلب السعر وسيتواصل معك فريق S.A. LOGISTICS في أقرب وقت.",
    ...
    contact: {
      sectionTag: "بضاعتك.. التزامنا الكامل",
      ...
      chinaTitle: "مستودعات ومكاتب الصين",
      ...
      officialAddress: "دمشق - شارع الحمراء - بالقرب من فندق بلـو تاور",
      officialPhone: "+963 9666 42574",
      officialEmail: "SA.LOGISTICS.SY@GMAIL.COM",
    },
    footer: {
      description:
        "شركة S.A. LOGISTICS | الشحن الدولي من وإلى سوريا وعبرها. حلول لوجستية موثوقة وتنسيق كامل لكافة الشحنات الجوية والبحرية والبرية.",
      quickLinks: "روابط سريعة",
      servicesTitle: "خدمات الشحن",
      officesTitle: "المنافذ والموانئ",
      rights: "جميع الحقوق محفوظة © 2026 شركة S.A. LOGISTICS",
      chinaTagline: "الناس • البضائع • الانتشار العالمي • مستقبل أفضل",
